...
local M = {
	...
	rotation_period                 = 1800000, -- time in ms
	...
	incubation_period = 0,
	hash = 1235,
	incubator_name = string.format("incu-%s",wifi.sta.getmac()),
	rotate_up                       = true,
...
-------------------------------------------------------------------------------------------------
-- @function set_hash
-- varifies if the input string is at most 30 characters long and sets it as the hash if valid.
-- @param	new_hash
-------------------------------------------------------------------------------------------------
