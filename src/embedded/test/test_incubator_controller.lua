...
describe('malfunction alert', function()
    it('temperature is stable an resitor is on', function()
        ...
        assert.spy(_G.print).was.called_with("alertas,device=JJ-RIO4 count=1,message=\"temperature is not changing\" 1676515676854775805946888192")
        assert.spy(_G.print).was.called_with("alertas,device=JJ-RIO4 count=2,message=\"temperature < M.min_temp and resistor is off\" 1676515676854775805946888192")
